	...
	<fieldset style="width:100%; border:solid 2px; margin:10px auto" >
		<legend>Nhập thông tin sản phẩm</legend>
           <form action="index.php?act=insert_sanpham" method="post" id="spp">
			Mã sản phẩm &nbsp; <input type="text" name="msp" id="msph"><label id="msph_error" class="error"></label><br><br>
			Tên sản phẩm  &nbsp;<input type="text" name="tsp" id="tsph"><label id="tsph_error" class="error"></label><br><br>
			...
			Màn hình &nbsp;<input type="text" name="mah" id="mahi"><label id="mahi_error" class="error"></label><br><br>
			CPU	&nbsp;<input type="text" name="cpu" id="cpuu"><label id="cpuu_error" class="error"></label><br><br>
			VGA	&nbsp;<input type="text" name="vga" id="vgaa"><label id="vgaa_error" class="error"></label><br><br>
			Hệ điều hành	&nbsp;<input type="text" name="hdh" id="hdhh"><label id="hdhh_error" class="error"></label><br><br>
			Pin	&nbsp;<input type="text" name="pin" id="pinn"><label id="pinn_error" class="error"></label><br><br>
			Số lượng &nbsp;<input type="text" name="sl" id="sll"><label id="sll_error" class="error"></label><br><br>
			Giá gốc	&nbsp;<input type="text" name="gg" id="ggg"><label id="ggg_error" class="error"></label><br><br>
			Giá khuyến mãi &nbsp;<input type="text" name="gkm" id="gkmm"><label id="gkmm_error" class="error"></label><br><br>
			Thời gian bảo hành &nbsp;<input type="text" name="tgbh" id="tgbhh"><label id="tgbhh_error" class="error"></label><br><br>
			Tình trạng &nbsp;<input type="text" name="tt"id="ttt"><label id="ttt_error" class="error"></label><br><br>
			...
			Mô tả &nbsp;
			 ...
			 <textarea id="contentchau" name="contentchau"></textarea> <label id="mt_error" class="error"></label>
