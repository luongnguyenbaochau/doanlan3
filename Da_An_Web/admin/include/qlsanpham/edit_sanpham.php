	...
	$data = $sanpham->getDetail($masanpham);
		...
		<legend>Nhập thông tin sản phẩm</legend>
           <form action="index.php?act=edit_sanpham2" method="post" id="spp">
			...
			Tên sản phẩm  &nbsp;<input type="text" name="tsp" value="<?php echo $data["tensanpham"];?>" id="tsph"><label id="tsph_error" class="error"><br><br>
			...
			Màn hình &nbsp;<input type="text" name="mah" value="<?php echo $data["manhinh"];?>" id="mahi"><label id="mahi_error" class="error"></label><br><br>
			CPU	&nbsp;<input type="text" name="cpu" value="<?php echo $data["cpu"];?>" id="cpuu"><label id="cpuu_error" class="error"></label><br><br>
			VGA	&nbsp;<input type="text" name="vga" value="<?php echo $data["vga"];?>" id="vgaa"><br><br>
			Hệ điều hành	&nbsp;<input type="text" name="hdh" value="<?php echo $data["hdh"];?>" id="hdhh"><label id="hdhh_error" class="error"></label><br><br>
			Pin	&nbsp;<input type="text" name="pin" value="<?php echo $data["pin"];?>" id="pinn"><label id="pinn_error" class="error"></label><br><br>
			Số lượng &nbsp;<input type="text" name="sl" value="<?php echo $data["soluong"];?>" id="sll"><label id="sll_error" class="error"></label><br><br>
			Giá gốc	&nbsp;<input type="text" name="gg" value="<?php echo $data["giagoc"];?>" id="ggg"><label id="ggg_error" class="error"></label><br><br>
			Giá khuyến mãi &nbsp;<input type="text" name="gkm" value="<?php echo $data["giakhuyenmai"];?>" id="gkmm"><label id="gkmm_error" class="error"></label><br><br>
			Thời gian bảo hành &nbsp;<input type="text" name="tgbh" value="<?php echo $data["thoigianbaohanh"];?>" id="tgbhh"><label id="tgbhh_error" class="error"></label><br><br>
			Tình trạng &nbsp;<input type="text" name="tt" value="<?php echo $data["tinhtrang"];?>" id="ttt"><label id="ttt_error" class="error"></label><br><br>
			...
			Mô tả &nbsp;
			 <textarea id="contentchau" name="contentchau"><?php echo $data["mota"];?></textarea><label id="mt_error" class="error"></label>
